...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        # ! CHANGE
        # current_timestep = self._current_progress_remaining
...
for step in range(total_timesteps): 
    rdm_num = np.random.choice(np.arange(step, min(total_timesteps, step + max_delay)))
    delay_dict[rdm_num].append(step)  
